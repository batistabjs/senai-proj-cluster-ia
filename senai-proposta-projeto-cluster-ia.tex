...
% -------------------------
\chapter{Busca por parcerias para construção do Cluster On-Premisse}

Como observado, o modelo on-premise apresenta vantagens estratégicas. Não só para a instituição, mas também para empresas parceiras. 
Esse capítulo elenca algumas possíveis estratégias para a criação de incentivos às parcerias.
...
\begin{itemize}
    ...
    \item Associação direta com inovação
    \item Exposição contínua a 10.000 alunos por ano
