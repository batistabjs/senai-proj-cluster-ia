...
\titulo{IMPLEMENTAÇÃO DE CLUSTER DE INTELIGÊNCIA ARTIFICIAL GENERATIVA NO SENAI/SESI EM SANTA CATARINA
\\Projeto / Proposta para Parcerias
}
...
\tipotrabalho{}
\preambulo{Proposta para criação de infraestrutura física para cluster de Inteligência Artificial destinada ao ensino de Desenvolvimento de Sistemas e áreas correlatas no SENAI Santa Catarina.\\
}
